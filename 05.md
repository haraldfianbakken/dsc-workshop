...
## Setup pull server
See <a href="../../tree/master/pull-server/ConfigurePullServer.ps1">ConfigurePullServer</a>

## Create the LCM configuration and register the pull client
See <a href="../../tree/master/pull-client/ConfigureInsecurePullClient.ps1">ConfigureInsecurePUllClient.ps1</a>
